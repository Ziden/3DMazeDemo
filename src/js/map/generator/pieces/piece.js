...
export default class Piece {
    ...
    constructor(options) {
        ...
        this.exits = [];
        this.children = [];
        this.get_inner_perimeter = this.get_inner_perimeter.bind(this);
        this.get_non_wall_tiles = this.get_non_wall_tiles.bind(this);
    }
    ...
    get_inner_perimeter() {
        ...
        this.perimeter.forEach( perim => {
            const pos = perim[0];
            const globalPos = this.global_pos(pos);
            if(!this.walls.get(globalPos)) {

            }
        });

/*
        this.walls.forEach((isWall, i) => {
